...
document.getElementById("btnRemoverUltimoElemento").addEventListener("click", function(event) {
    event.preventDefault();

    removerUltimoElemento(lista);
});

document.getElementById("btnRemoverElementos").addEventListener("click", function(event) {
    event.preventDefault();
